...
public enum GUI {
	...
	// HISTORY_PROGRESS(4), // Indicates a progress update from history
    // processing.
	// REPORT_PROGRESS(5), // Indicates a progress update from report
    // processing.
	DEFAULT_VERSION_DIR, // Default directory to open when browsing for
                            // versions.
