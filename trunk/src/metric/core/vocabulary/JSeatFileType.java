...
public enum JSeatFileType {
	ALL_SUPPORTED("*.ver;*.rep;*.jpf", "Supported File Types (*.ver;*.rep;*.jpf)"),
	VERSION("*.ver", "JSeat Version File (*.ver)"),
	REPORT("*.rep", "JSeat Report Configuration File (*.rep)"),
	PROJECT("*.jpf", "JSeat Project File (*.jpf)");	
