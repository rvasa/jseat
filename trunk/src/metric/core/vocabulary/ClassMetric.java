...
public enum ClassMetric {
	...
	ILOAD_COUNT, ISTORE_COUNT, TYPE_INSN_COUNT, LOAD_FIELD_COUNT, STORE_FIELD_COUNT, ZERO_OP_INSN_COUNT,
	...
	GUI_DISTANCE, COMPUTED_DISTANCE, // used to store distance once computed
